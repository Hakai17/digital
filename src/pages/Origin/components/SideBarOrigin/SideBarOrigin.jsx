...
import { FieldsSearchOrigin } from "../FieldsSearchOrigin/FieldsSearchOrigin";
import {
  Accordion,
  AccordionContent,
  AccordionHeader,
...
export const SideBarOrigin = ({ onSearch, setEditarAdicionar }) => {
  return (
    <Container
      variant="permanent"
      anchor="left"
      ...
      <Box>
        <Formik initialValues={initialValues} onSubmit={onSearch}>
          {({ resetForm, submitForm }) => (
            <Form>
              <TypographyTitle>Origem</TypographyTitle>
