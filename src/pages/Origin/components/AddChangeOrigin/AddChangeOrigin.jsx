...
import { OriginPanel } from "../OriginPanel/OriginPanel";
import { StyledForm, StyledFormik, TabContent, TabFooter } from "./styles";

export const AddChangeOrigin = ({ originId, handleCancel, onSave }) => {
  const isAddMode = !originId;
  ...
  const handleSubmit = async valuesForm => {
    try {
      ...
      var { data } = await api.post(
        "/cadastroAtendimento/salvarOrigem",
        valuesForm
      );
      valuesForm.id = data;
      enqueueSnackbar(
