...
import { Indicator1DataForm } from "./components/Indicator1DataForm";
...
export function PagesIndicator1({ onSave = null }) {
  ...
  const { data: indicators1, refetch } = useQuery({
    queryKey: ["indicators1", { id, descricao }],
    queryFn: () => post("/produto/listagemId1", { id, descricao }),
  });
