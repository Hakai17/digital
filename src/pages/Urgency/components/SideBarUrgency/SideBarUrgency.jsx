...
import { FieldsSearchUrgency } from "../FieldsSearchUrgency/FieldsSearchUrgency";
import {
  Accordion,
  AccordionContent,
  AccordionHeader,
...
export const SideBarUrgency = ({ onSearch, setEditarAdicionar }) => {
  return (
    <Container
      variant="permanent"
      anchor="left"
      ...
      <Box>
        <Formik initialValues={initialValues} onSubmit={onSearch}>
          {({ resetForm, submitForm }) => (
            <Form>
              <TypographyTitle>Urgência</TypographyTitle>
