...
import { fieldsContact } from "../../constants";
...
async function setDefaultUserValues({
  ...
  try {
    ...
    const data = await get(
      `/cadastroAtendimento/buscarTipoContato?id=${contactId}`
    );
    fieldsContact.forEach(field => setFieldValue(field, data[field], false));
...
export function ContactPanel({ isAddMode, contactId, ...props }) {
